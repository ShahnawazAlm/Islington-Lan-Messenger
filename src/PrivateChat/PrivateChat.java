...
public class PrivateChat extends javax.swing.JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        final String secretKey = "secrete";
          PrivateChat aesEncryptionDecryption = new PrivateChat();
                            String encryptedString = aesEncryptionDecryption.encrypt(inputMessage, secretKey);
                            String decryptedString = aesEncryptionDecryption.decrypt(encryptedString, secretKey);
        chatTextArea.append("You: "+ encryptedString + "\n");
